<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="left" :width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('reports.warranty')">
                                    {{ __('Warranty') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('reports.assigned')">
                                    {{ __('Assigned Assets') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('reports.maintenance')">
                                    {{ __('Maintenance Cost') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('reports.retired')">
                                    {{ __('Retired Assets') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('reports.warranty')" :active="request()->routeIs('reports.warranty')">
                {{ __('Warranty Report') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('reports.assigned')" :active="request()->routeIs('reports.assigned')">
                {{ __('Assigned Assets Report') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('reports.maintenance')" :active="request()->routeIs('reports.maintenance')">
                {{ __('Maintenance Cost Report') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('reports.retired')" :active="request()->routeIs('reports.retired')">
